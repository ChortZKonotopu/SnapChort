  ...
  return (
    <div className='post-card'>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex-center gap-2 text-light-3">
              <p className='subtitle-semibold lg:small-regular'>{multiFormatDateString(post.$createdAt)}</p> - 
      ...
      <Link to={`/posts/${post.$id}`}>
        ...
        <img src={post.imageUrl || '/assets/icons/profile-placeholder.svg'} alt="post-card_img" className='post-card-img' />
      </Link>
